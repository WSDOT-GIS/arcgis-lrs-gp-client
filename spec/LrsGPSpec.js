...
describe("LrsGP", function () {
    ...
    describe("Calling GP Service", function () {
        ...
        describe("Actually call GP service and await response", function () {
            ...
            it("should support NOT keeping only the closest route location", function (done) {
                const expectedResults = {
                    "results": [{
                        "paramName": "Output_Route_Events",
                            ...
                            "features": [
                                {
                                    "attributes": {
                                        "OID": 1,
                                        "RouteId": "009d",
                                        "Measure": 1.51631306583,
                                        "Distance": -22.2956078224,
                                        "INPUTOID": 1,
                                        "LOC_ANGLE": 180.07219325077523
                                    },
                                    "geometry": {
                                        "x": -122.14354575099998,
                                        "y": 47.80407312300008,
                                        "z": 0,
                                        "m": 1.516300000002957
                                    }
                                },
                                {
                                    "attributes": {
                                        "OID": 2,
                                        "RouteId": "009",
                                        "Measure": 1.51791641945,
                                        "Distance": 23.4309729627,
                                        "INPUTOID": 1,
                                        "LOC_ANGLE": 178.54650259513227
                                    },
                                    "geometry": {
                                        "x": -122.14335973799996,
                                        "y": 47.80407418200008,
                                        "z": 0,
                                        "m": 1.5179000000061933
                                    }
                                }
                            ],
                            "exceededTransferLimit": false
                ...
                var gpParams = new LrsGPParameters({
                    Input_Features: { "features": [{ "attributes": {}, "geometry": { "x": -13596947.221488329, "y": 6074321.483306807, "spatialReference": { "latestWkid": 3857, "wkid": 102100 } } }], "geometryType": "esriGeometryPoint" },
                    Search_Radius: {
                        "distance": 50,
                        "units": "esriFeet"
                    },
